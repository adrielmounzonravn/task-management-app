...
export type CreateTaskMutation = { createTask: { id: string, name: string, pointEstimate: PointEstimate, status: Status, dueDate: string, tags: Array<TaskTag>, assignee: { id: string, fullName: string, avatar: string | null } | null } };
